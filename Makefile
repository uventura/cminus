...
CFLAGS += -D_GNU_SOURCE  # Add this line
CFLAGS += -Icminus/syntactic
...
#           MAIN          |
#==========================
all: $(SYNTACTIC_HDR) $(LEXER_OUT) $(TARGET)
...
$(TARGET): $(OBJS) $(LEXER_OBJ) $(SYNTACTIC_OBJ)
	...
	@mkdir -p $(BIN_DIR)
	@$(CC) -o $(BIN_DIR)/$@ $^ $(LDFLAGS) $(CFLAGS) -O3 -Icminus
...
lexer: $(OBJS) $(LEXER_OBJ) $(SYNTACTIC_HDR)
	@echo "Building Lexer..."
	@mkdir -p $(BIN_DIR)
	@$(CC) -o $(BIN_DIR)/$@ $^ $(LDFLAGS) $(CFLAGS) -O3 -Icminus -DDEBUG -DLEXER_MODE
	@echo "> Successfully generated!"
...
syntactic: $(OBJS) $(LEXER_OBJ) $(SYNTACTIC_OBJ) $(SYNTACTIC_HDR)
	...
	@mkdir -p $(BIN_DIR)
	@$(CC) -o $(BIN_DIR)/$@ $^ $(LDFLAGS) $(CFLAGS) -O3 -Icminus -DDEBUG
	@echo "> Successfully generated!"
...
# SRCS := $(filter-out $(SYNTACTIC_OUT), $(SRCS))
# SRCS := $(filter-out $(LEXER_OUT), $(SRCS))
# SRCS += cminus/semantic/semantic.c  # Add this line
